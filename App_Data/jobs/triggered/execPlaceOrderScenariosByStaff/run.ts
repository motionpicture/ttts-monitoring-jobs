        ...
        async () => {
            ...
            try {
                ...
                const { transactionResult } =
                    // tslint:disable-next-line: no-magic-numbers
                    await Scenario.main(sellerIdentifier, durationInSeconds * 1000, configurations.username, configurations.password);
...
async function reportResults(configurations: IConfigurations, unsortedResults: IResult[]) {
    // sort result
