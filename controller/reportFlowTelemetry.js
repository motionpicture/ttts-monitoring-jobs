...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const globalTelemetries = yield ttts.service.report.telemetry.searchGlobalFlow({
        ...
        const sellerTelemetries = yield ttts.service.report.telemetry.searchSellerFlow({
            measuredFrom: measuredFrom.toDate(),
            measuredThrough: dateNowByUnitTime.toDate()
        })(telemetryRepo);
        ...
        yield Promise.all(corporations.map((corporation) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield reportNumberOfTransactionsByStatuses(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate()); // ステータスごとの取引数
            yield reportExpiredRatio(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate());
            yield reportTimeLeftUntilEvent(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate());
            yield reportTransactionRequiredTimes(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate()); // 平均所要時間
            yield reportTransactionAmounts(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate()); // 平均金額
            yield reportTransactionActions(corporation.name.ja, telemetriesBySellerId, measuredFrom.toDate(), dateNowByUnitTime.toDate()); // 平均アクション数
        })));
    });
}
exports.main = main;
...
function reportNumberOfTrialsOfTasks(telemetries, measuredFrom, measuredThrough) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(targetTaskNames.map((taskName) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield ttts.service.notification.report2developers(`タスク実行試行回数\n${taskName}`, '', imageFullsize, imageFullsize)();
        })));
    });
}
/**
...
function reportLatenciesOfTasks(telemetries, measuredFrom, measuredThrough) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(targetTaskNames.map((taskName) => __awaiter(this, void 0, void 0, function* () {
            ...
            const imageFullsize = yield GoogleChart.publishUrl(params);
            debug('url published.', imageFullsize);
            yield ttts.service.notification.report2developers(`タスク待機時間\n${taskName}`, '', imageFullsize, imageFullsize)();
        })));
    });
}
/**
